...
#
#   based on starField, captureFrames demos 
#    from PsychoPy2 http://www.psychopy.org/
#
...
#
#   See https://github.com/rogilmore/moco-mofo-demo/blob/master/make-movie-from-jpg.md
#   
